      ...
      if (state == 'complete') {
        setTimeout(function () {
          ...
          $this.$axios.get('/api/company').then(function (response) {
            ...
            $this.isLoading = true;
            $this.bgbanner = {
              background: 'url("' + $this.company.data.banner + '") no-repeat',
              "background-attachment": "fixed"
            };
            $this.portofolio_banner = {
              background: 'url("' + $this.company.data.portofolio_banner + '") no-repeat',
              "background-attachment": "fixed"
            };
            $this.faq_banner = {
              "background-image": 'url("' + $this.company.data.faq_banner + '")'
            };
            // $this.counterRun(); 
            // if($this.isLoading){
            //     /**
                        ...
                        _vm.contacts1.data
                          ? _c(
                              "a",
                              {
                                ...
                                attrs: { href: _vm.contacts1.data.youtube },
                              },
                              [
