  ...
  <section class="section">
      <div class="iconslist">
        ...
        <div class="icon">
          ...
          <div class="label">boxes 2</div>
        </div>
        <div class="icon">
          <i class="bi bi-building-fill-check"></i>
          <div class="label">bi bi-building-fill-check</div>
        </div>
        <div class="icon">
          <i class="bi bi-building"></i>
          <div class="label">bi bi-building</div>
        </div>
        <div class="icon">
          <i class="bi bi-clipboard-data"></i>
          <div class="label">bi bi-clipboard-data</div>
        </div>
        <div class="icon">
          <i class="bi bi-clipboard2-check"></i>
          <div class="label">bi bi-clipboard2-check</div>
        </div>
        <div class="icon">
