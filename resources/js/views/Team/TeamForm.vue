  ...
  savebenefits(e){
    ...
    formData.append("_token", token);
      let stat = 'error',
          msg = 'Failed add team';
    if(this.isAdd){
      this.$axios.post("api/team/", formData)
        .then((response) => {
          this.proses = false;
              this.$validation(response.data.msg,this.jsonResp)
              if(response.data.status){
                stat = 'success',
                msg = 'Success add team'; 
      ...
      this.$axios.post("api/team/" + this.thisId, formData)
        .then((response) => {
          this.proses = false;
          let stat = 'error',
